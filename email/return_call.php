...
$business_type = get_value("business-type");
...
if($business_type != "homepage" && $business_type != "vereniging" && $business_type != "recreatie") {
    $response['text'] = "Incorrect business-type";
    die(json_encode($response));
}

require_once("../captcha/captcha.php");

if(use_captcha(0, $email, $_SERVER['REMOTE_ADDR'], true)) {
...
$mail->Subject = 'Inzending via bel-mij-terugformulier ('.$business_type.')';
$mail->Body = $html;
//$mail->AltBody = $plain;
                ...
                <tr>
                  <td align="left" width="100%">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
                      <tbody>
                        <tr>
                          <td style="width:630px" align="center" valign="top" width="630"><img style="display:block;border:0" src="http://kpnhotspots.welikemilk.nl/mailings/1/kpn-wifi-hotspots-email-header-bel-mij-terugformulier.png" alt="Slimmer om thuis vast te bellen i.p.v. mobiel" width="630" height="210" border="0" tabindex="0" class="CToWUd a6T"/>
                                ...
                                <tr>
                                  <td align="left" valign="top">
                                    <table style="font-family:Arial,Helvetica,sans-serif;color:#000000;font-size:14px;line-height:21px" width="570" border="0" cellspacing="0" cellpadding="0" align="right">
                                      <tbody>
                                        <tr>
                                          <td style="font-family:Arial,Helvetica,sans-serif;color:#000000;font-size:14px;line-height:21px" align="left" valign="top" width="496"><span style="font-family:Arial,Helvetica,sans-serif;color:#000000;font-size:14px;line-height:21px"><span class="im"><br/>Beste $name,<br/><br/>Bedankt voor uw interesse in KPN WiFi HotSpots!<br/><br/>U heeft deze contactgegevens aan ons doorgegeven:<br/><br/>Bedrijf: $company<br/>Telefoonnummer: <a href="$phone_number">$phone_number</a><br/>E-mailadres:&nbsp;<a href="mailto:$email">$email</a><br/><br/>We nemen binnen twee werkdagen telefonisch contact met u op. Mocht u eerder contact met ons willen, dan staan we u graag te woord op 0800 0414.<br/><br/>Met vriendelijke groet,<br/><br/>Robert Bakker<br/>Commercieel Manager<br/>KPN WiFi HotSpots</span></span></td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </td>
...
We nemen binnen twee werkdagen telefonisch contact met u op. Mocht u eerder contact met ons willen, dan staan we u graag te woord op 0800 0414.
...
$mail->FromName = 'KPNHotSpots';
$mail->addAddress($email, $name);
$mail->addReplyTo('verkoop-kpnhotspots@kpn.com', 'KPNHotSpots');
$mail->CharSet = 'UTF-8';
$mail->IsSMTP();
$mail->Host = "localhost";
$mail->isHTML(true);

$mail->Subject = 'Bevestiging van uw informatieaanvraag bij KPN WiFi HotSpots';
$mail->Body = $html;
$mail->AltBody = $plain;
